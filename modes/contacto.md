...
3. **Generate message** with a 3-sentence framework:
   - **Sentence 1 (Hook)**: Something specific about their company or current challenge (NOT generic)
   - **Sentence 2 (Proof)**: Candidate's most quantifiable achievement relevant to THAT role (e.g., "I authored post-market surveillance documentation aligned to FDA and EU MDR at a medtech company")
   - **Sentence 3 (Proposal)**: Quick chat, no pressure ("Would love to chat about [specific topic] for 15 min")

4. **Language**: EN (default)
