...
4. **When finished**, show ONLY this compact summary table (no per-offer detail):

```
| # | Company | Role | Score | Verdict | PDF |
```

Do not print individual evaluation blocks. All detail is in the report files.
...
## Processed
- [x] #143 | https://jobs.example.com/posting/789 | Acme Corp | Reg Affairs Specialist | 4.2/5 | PDF ✅
- [x] #144 | https://boards.greenhouse.io/xyz/jobs/012 | BigCo | Medical Writer | 2.1/5 | PDF ❌
```
